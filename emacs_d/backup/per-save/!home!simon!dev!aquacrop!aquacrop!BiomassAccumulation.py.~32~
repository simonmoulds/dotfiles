...
class BiomassAccumulation(object):
    ...
    def dynamic(self):
        ...
        # print('WPadj   : ',WPadj[0,0,0])
        # print('TrPot_NS: ',self.var.TrPot_NS[0,0,0])
        # print('TrAct   : ',self.var.TrAct[0,0,0])
        # print('Et0     : ',self.var.model.etref.values[0])
        dB = self.compute_biomass_accumulation_on_current_day(WPadj, self.var.TrAct)
        # print('TrPot_NS:', self.var.TrPot_NS[0,0,0])
        # print('TrAct:', self.var.TrAct[0,0,0])
        # print('WP_adj:', WPadj[0,0,0])
        # print('dB    :', dB[0,0,0])
        # print('dB_NS :', dB_NS[0,0,0])
        self.var.B +=dB
        self.var.B_NS += dB_NS
