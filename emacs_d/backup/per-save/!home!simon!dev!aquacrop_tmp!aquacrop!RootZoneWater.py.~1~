...
class RootZoneWater(object):
    ...
    def dynamic(self):
        ...
        aquacrop_fc.root_zone_water_w.update_root_zone_water_w(
            ...
            np.asfortranarray(self.var.thRZ_Fc), 
            np.asfortranarray(self.var.thRZ_Wp), 
            np.asfortranarray(self.var.thRZ_Dry), 
            ...
            np.asfortranarray(self.var.th_dry), 
            np.asfortranarray(self.var.Aer), 
