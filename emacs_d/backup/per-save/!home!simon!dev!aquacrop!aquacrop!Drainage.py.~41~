...
class Drainage(object):
    ...
    def dynamic(self):
        ...
        drainsum = np.zeros((self.var.nFarm, self.var.nCrop, self.var.domain.nxy))
        for comp in range(self.var.nComp):
            ...
            excess = np.zeros((self.var.nFarm, self.var.nCrop, self.var.domain.nxy))
            ...
            thX = np.zeros((self.var.nFarm, self.var.nCrop, self.var.domain.nxy))
