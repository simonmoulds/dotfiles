...
class Infiltration(object):
    ...
    def dynamic(self):
        ...
        # # Initialize counters
        # comp = 0
        # Runoff = np.zeros((self.var.nFarm, self.var.nCrop, self.var.nCell))
        # cond3_ini = (ToStore > 0)
        ...
        #     theta0 = np.zeros((self.var.nFarm, self.var.nCrop, self.var.nCell))
        ...
        aquacrop_fc.infiltration_w.update_infl_w(
            ...
            np.asfortranarray(self.var.AppEff),
            np.asfortranarray(self.var.Bunds),
