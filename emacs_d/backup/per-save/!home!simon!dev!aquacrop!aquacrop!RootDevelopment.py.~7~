...
#             np.asfortranarray(self.var.rCor), 
#             np.asfortranarray(self.var.Zmin), 
#             np.asfortranarray(self.var.Zmax), 
#             np.asfortranarray(self.var.PctZmin), 
#             np.asfortranarray(self.var.Emergence), 
#             np.asfortranarray(self.var.MaxRooting), 
#             np.asfortranarray(self.var.fshape_r), 
#             np.asfortranarray(self.var.fshape_ex), 
#             np.asfortranarray(self.var.SxBot),
#             np.asfortranarray(self.var.SxTop),
...
#             np.asfortranarray(self.var.TrRatio),
#             np.asfortranarray(self.var.Germination), 
#             np.asfortranarray(self.var.zRes),
